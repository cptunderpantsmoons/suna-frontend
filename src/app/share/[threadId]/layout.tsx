...
export async function generateMetadata({ params }): Promise<Metadata> {
  ...
  const fallbackMetaData = {
    title: 'Shared Conversation | AtlasAI0',
    description: 'Replay this Agent conversation on AtlasAI0',
    alternates: {
  ...
  try {
    ...
    const title = projectData.name || 'Shared Conversation | AtlasAI0';
    const description =
      projectData.description ||
      'Replay this Agent conversation on AtlasAI0';
