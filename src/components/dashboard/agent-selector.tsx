...
export function AgentSelector({ 
  ...
  const displayName = currentAgent?.name || defaultAgent?.name || 'AtlasAI0';
  const agentAvatar = currentAgent?.avatar;
  const isUsingAtlas = !currentAgent && !defaultAgent;
              ...
              >
                <div className="flex items-center gap-2 w-full">
                  ...
                  <div className="flex items-center gap-1 flex-1 min-w-0">
                    <span className="font-medium truncate">AtlasAI0</span>
            ...
            >
              <div className="flex items-center gap-2 w-full">
                ...
                <div className="flex items-center gap-1 flex-1">
                  <span className="font-medium">AtlasAI0</span>
                  <Badge variant="outline" className="text-xs px-1 py-0">
                    Default
                  </Badge>
                </div>
